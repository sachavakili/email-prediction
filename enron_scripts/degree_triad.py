...
from features import GraphDegreeFeatures, GraphTriadFeatures
...
#%% Compute features using Degree Features 
...
XTRAIN = np.hstack((D_XTRAIN, T_XTRAIN))
XTEST = np.hstack((D_XTEST, T_XTEST))
...
# Output
if PRINT_OUTPUT:
    with open('../wikipedia_admin/results/degree_triad_predictions.csv', 
              'wb') as pred1:
